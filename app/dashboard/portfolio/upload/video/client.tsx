        ...
        <form onSubmit={handlePreSubmit} className={styles.form}>
          ...
          <div className={styles.section}>
            <label className="form-label">
              動画のアップロード方法 <span className={styles.required}>*</span>
            </label>
            ...
            {uploadMethod === 'file' && (
              <>
                {!videoFile ? (
                  <div
                    className={`${styles.dropzone} ${videoDragging ? styles.dragging : ''}`}
                  ...
                  <div className={styles.fileInfo}>
                    ...
                    <div className={styles.fileDetails}>
                      ...
                      <span className={styles.fileSize}>{(videoFile.size / (1024 * 1024)).toFixed(2)} MB</span>
                    </div>
                    <button type="button" onClick={removeVideo} className={styles.fileRemove}>
                ...
                {errors.video && (
                  <p className="form-error">
                    <i className="fa-solid fa-circle-exclamation"></i> {errors.video}
                  </p>
                )}
              </>
            )}
        ...
        <div className="modal-overlay active" onClick={() => setShowConfirmModal(false)}>
          <div className="modal" onClick={(e) => e.stopPropagation()} style={{ maxWidth: '600px' }}>
            ...
            <div className="modal-body">
              ...
              <div className={styles.confirmItem}>
                <span className={styles.confirmLabel}>動画</span>
                {uploadMethod === 'file' ? (
                  <span className={styles.confirmValue}>
                    <i className="fa-solid fa-file-video" style={{ marginRight: 'var(--space-2)' }}></i>
                    {videoFileName}
                  </span>
                ) : (
                  <span className={styles.confirmValue}>
