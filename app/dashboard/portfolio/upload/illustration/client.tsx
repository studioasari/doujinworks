          ...
          <main className="upload-illust-main">
            <div className="upload-illust-container">
              ...
              <div className="upload-illust-header">
                <h1 className="upload-illust-title">イラストをアップロード</h1>
                <button
                  type="button"
              ...
              <form onSubmit={handlePreSubmit} className="upload-illust-form">
                ...
                <div className="upload-illust-section">
                  <label className="upload-illust-label">
                    イラスト画像 <span className="required">*</span>
                  </label>
                  ...
                  {imageFiles.length === 0 ? (
                    ...
                    <div className="upload-illust-preview-grid">
                      {imagePreviews.map((preview, index) => (
                        <div
                          ...
                          className={`upload-illust-preview-item ${draggedIndex === index ? 'dragging' : ''} ${dragOverIndex === index ? 'dragover' : ''}`}
                        >
                          <img src={preview} alt={`プレビュー ${index + 1}`} />
                          {index === 0 && (
                            <span className="upload-illust-main-badge">メイン</span>
                          )}
                          <button
                            type="button"
                            onClick={(e) => { e.stopPropagation(); removeImage(index) }}
                            className="upload-illust-remove-btn"
                          >
                      ...
                      {imageFiles.length < 100 && (
                        <div
                          ...
                          onDragLeave={() => setDragging(false)}
                          onDrop={handleImageDrop}
                          className="upload-illust-add-btn"
                        >
      ...
      {showConfirmModal && (
        <div className="upload-illust-modal-overlay" onClick={() => setShowConfirmModal(false)}>
          <div className="upload-illust-modal" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="upload-illust-confirm-images">
              {imagePreviews.map((preview, index) => (
                <div key={index} className="upload-illust-confirm-image">
                  <img src={preview} alt={`プレビュー ${index + 1}`} />
                  {index === 0 && <span className="main-badge">メイン</span>}
                </div>
              ))}
            </div>
