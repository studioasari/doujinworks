            ...
            <form onSubmit={handleSubmit} className="card-no-hover p-40">
              ...
              <div className="mb-32">
                ...
                >
                  {audioFile ? (
                    <div>
                      <i className="fas fa-microphone" style={{ fontSize: '32px', color: '#1A1A1A', marginBottom: '12px' }}></i>
              ...
              <div className="mb-24">
                ...
                <textarea
                  ...
                  placeholder="ボイス作品の説明を入力してください（セリフ内容、キャラクター設定など）"
                  rows={6}
              ...
              <div className="mb-24">
                ...
                <input
                  ...
                  placeholder="タグをカンマ区切りで入力 (例: 少年, 高音, セリフ, ボイスドラマ)"
                  className="input-field"
                />
              </div>
