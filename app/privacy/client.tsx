    ...
    <>
      ...
      <div style={{ minHeight: '100vh', backgroundColor: 'var(--bg-base)' }}>
        <div className="container-narrow" style={{ padding: '40px 20px', maxWidth: '900px', margin: '0 auto' }}>
          <h1 className="section-title" style={{ marginBottom: 'var(--space-12)' }}>プライバシーポリシー</h1>
          ...
          <div style={{ fontSize: '14px', lineHeight: '1.7', color: 'var(--text-secondary)' }}>
            ...
            <div className="privacy-section">
              ...
              <ul className="item-list">
                ...
                <li>本人確認書類の記載事項（運転免許証、パスポート、マイナンバーカード（表面のみ、個人番号記載の裏面は取得しません）等の公的身分証明書）</li>
            ...
            <div className="privacy-section">
              ...
              <div className="subsection-title">（6）外国にある第三者への提供</div>
              <p style={{ marginLeft: '24px' }}>
                当社は、本サービスの提供に伴い、以下の外国にある第三者に個人情報を提供する場合があります。当社は、当該外国における個人情報の保護に関する制度等を把握した上で、適切な安全管理措置を実施します。
              </p>
              <ul className="item-list">
                <li>アメリカ合衆国（決済代行会社、クラウドインフラ事業者、メール配信事業者、アクセス解析事業者等）</li>
              </ul>
              <div className="note-box">
                ※ アメリカ合衆国における個人情報保護制度の詳細については、個人情報保護委員会のウェブサイト（https://www.ppc.go.jp/）をご確認ください。<br />
                ※ 提供先の事業者との間で個人情報保護法に適合する契約を締結し、適切な安全管理措置を実施しています。
              </div>
            </div>
            ...
            <div className="privacy-section">
              ...
              <p style={{ marginTop: '12px' }}>
                外部送信される情報の詳細、送信先、利用目的、オプトアウト方法等については、<a href="/cookie_policy" style={{ color: 'var(--accent-primary)', textDecoration: 'underline' }}>外部送信ポリシー</a>をご確認ください。
              </p>
            </div>
            ...
            <div className="privacy-section">
              ...
              <div className="subsection-title">（5）外的環境の把握</div>
              <p style={{ marginLeft: '24px' }}>
                当社は、お客様の個人情報を外国（アメリカ合衆国等）のクラウドサーバー等で保管する場合があります。その際、当社は当該外国の個人情報保護に関する制度を把握した上で、適切な安全管理措置を実施します。
              </p>
            </div>
            ...
            <div className="privacy-section">
              ...
              <p>
                当社は、お客様の個人情報を、第3条に定める利用目的の達成に必要な期間に限り保有します。ただし、各種法令（税法等）により保存が義務付けられている情報については、当該法令の定める期間にわたり適法に保存します。利用目的を達成し、かつ法令上の保存義務期間が経過した個人情報については、遅滞なく消去または匿名化等の適切な措置を講じます。
              </p>
            </div>
            ...
            <div className="privacy-section">
              ...
              <div style={{ marginTop: '20px', padding: '20px', backgroundColor: 'var(--bg-elevated)', borderRadius: '4px' }}>
            ...
            <div className="privacy-section">
              ...
              <p style={{ marginBottom: '12px' }}>
                本プライバシーポリシーに起因又は関連する一切の紛争については、名古屋地方裁判所又は名古屋簡易裁判所を第一審の専属的合意管轄裁判所とします。
              </p>
              <p>
                前項の規定にかかわらず、お客様が消費者契約法上の「消費者」に該当する場合、民事訴訟法の定めに従い、被告の普通裁判籍の所在地を管轄する裁判所、又は当該お客様の住所地を管轄する裁判所を第一審の管轄裁判所とします。
              </p>
            </div>
